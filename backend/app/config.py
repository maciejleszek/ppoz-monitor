...
class Settings(BaseSettings):
    ...
    # Źródło TED — przetargi UE powyżej progów (oficjalne Search API v3).
    enable_ted: bool = True

    # Źródło Baza Konkurencyjności — zapytania ofertowe z projektów UE,
    # często poniżej progów Pzp (endpoint sondowany; diagnostyka: /api/debug/bk).
    enable_bk: bool = True
