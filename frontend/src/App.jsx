...
import { SOURCE_LABELS_LONG } from "./utils";
...
export default function App() {
  ...
  useEffect(() => {
    ...
    const running =
      ...
      Object.values(stats?.last_runs || {}).some((r) => r.status === "running");
    if (running) {
  ...
  return (
    <div className="page">
      ...
      <main className="container">
        ...
        {!loading && !error && data.items.length === 0 && (
          <EmptyState
            ...
            lastRun={stats?.last_runs?.bzp || stats?.last_run}
            onReset={resetFilters}
          />
        )}
      ...
      <footer className="footer">
        <p>
          Źródła danych:{" "}
          {Object.keys(stats?.sources || { bzp: 0 })
            .map((s) => SOURCE_LABELS_LONG[s] || s)
            .join(" · ")}
          .
        </p>
        <p>
