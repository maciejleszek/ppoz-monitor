...
export const SOURCE_LABELS = { bzp: "BZP", ted: "TED", bk: "BK" };

export const SOURCE_LABELS_LONG = {
  bzp: "Biuletyn Zamówień Publicznych (e-Zamówienia, UZP)",
  ted: "TED — przetargi unijne",
  bk: "Baza Konkurencyjności (fundusze UE)",
};
